...
const NewsItemDetails = ({
    ...
    const [activeSlug, setSlug] = useState<string>(router.query.type as string)
    const [activeNews, setActiveNews] = useState<any[]>([..._news])
    ...
    return (
        <>
            ...
            <Content padding>
                {/* <div className='mt-0 border-0 grid_head'>
          <TopSection padding>
            <Header size={2} className='mb-5 text-center'>
              {title}
            </Header>
                ...
                <StyledBlockForGrid
                    ...
                    content={
                        <GridModule columns={4} sideScrollOnMobile>
                            {otherNews &&
                                otherNews.map((news: News, i: number) => (
                                    <NewsItem
                                        key={news.slug + i}
                                        newsObj={news?.fields}
                                    ></NewsItem>
